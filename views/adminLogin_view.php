...
<head>
    ...
    <title>Sala gaming | Admin Login</title>
    ...
    <div class="container">
        <div class="card border-success mx-auto">
            <div class="card-body px-4 py-4">
                <h3 class="card-title text-center mb-3 text-white">Login Admin</h3>
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="card-body ">
                    ...
                    <div class="form-group d-flex justify-content-center mt-4">
                        <input type="submit" name="submit" value="Iniciar Sesión" class="btn btn-success rounded-0">
                    </div>
                </form>
                <!-- Imprimo msj error-->
