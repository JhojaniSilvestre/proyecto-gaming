            ...
            <div class="col-lg-12">
              ...
              <div class="item">
                <ul>
                  ...
                  <li>
                    <h4>Usuario</h4><span><?php echo $_SESSION['username']; ?></span>
                  </li>
                  <li>
                    <h4>Email</h4><span><?php echo $_SESSION['email']; ?></span>
                  </li>
                  <li>
                    <h4>Victorias</h4><span>0</span>
                  </li>
                  <li>
                    <div class="online"><a href="#">Online</a></div>
                  </li>
                </ul>
              </div>
            </div>
