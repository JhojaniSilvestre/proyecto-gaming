...
-- Tiempo de generación: 02-12-2022 a las 18:34:56
...
(1, '2022-11-01 11:15:00', 1, 1, 3, 1, 1),
(2, '2022-11-02 17:45:00', 2, 2, NULL, 1, 1),
(3, '2022-12-01 11:15:00', 4, 1, NULL, 1, 1),
(4, '2022-12-10 11:15:00', 8, 1, NULL, 1, 1),
(5, '2022-12-01 11:15:00', 1, 1, NULL, 0, 1),
(6, '2022-12-01 11:15:00', 2, 1, NULL, 0, 1),
(7, '2022-12-01 11:15:00', 3, 1, NULL, 0, 1),
(8, '2022-12-01 11:15:00', 5, 1, NULL, 0, 1),
(9, '2022-12-01 11:15:00', 6, 1, NULL, 0, 1),
(10, '2022-12-01 11:15:00', 7, 1, NULL, 0, 1),
(11, '2022-12-01 11:15:00', 8, 1, NULL, 0, 1),
(12, '2022-12-01 11:15:00', 9, 1, NULL, 0, 1),
(13, '2022-12-01 11:15:00', 10, 1, NULL, 0, 1),
(14, '2022-12-01 11:15:00', 10, 1, NULL, 0, 1);
...
INSERT INTO `participants` (`id_participant`, `id_tournament`, `id_seat`, `id_user`, `active`) VALUES
(1, 1, 1, 1, 0),
(2, 2, 2, 1, 1),
(3, 1, 8, 1, 1),
(4, 1, 7, 1, 1),
...
CREATE TABLE IF NOT EXISTS `tournaments` (
  ...
  KEY `tournaments_FK_2` (`responsible`)
...
INSERT INTO `tournaments` (`id_tournament`, `name`, `date`, `id_game`, `responsible`, `active`) VALUES
(1, 'TORNEO1', '2022-11-11 11:15:00', 2, 2, 0),
(2, 'torneo2', '2022-11-30 11:15:00', 2, 3, 1),
(3, 'Torneo 3', '2022-12-02 11:15:00', 1, 2, 1),
(4, 'Torneo 4', '2022-12-07 11:15:00', 3, 2, 1),
(5, 'Torneo 3', '2022-12-11 11:15:00', 1, 2, 1),
(6, 'Torneo 3', '2022-12-10 11:15:00', 2, 1, 1),
(7, 'Torneo7', '2022-12-14 11:15:00', 3, 2, 1);
...
INSERT INTO `wins` (`id_win`, `number`, `id_participant`) VALUES
(1, 1, 1),
(2, 1, 2);
